...
const addition = {
    ...
    invertAdditionTable() {
        ...
        if (settings.additionInvert) {
            for (let y = 0; y < this.additionTable.length; y++) {
                for (let x = 0; x < this.additionTable[0].length; x++) {
                    this.additionTable[y][x] = 1 - this.additionTable[y][x];
                }
            }
        }
