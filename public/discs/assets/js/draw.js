...
const draw = {
    ...
    animate() {
        ...
        // reset all points
        /*
        let farthestNearest = settings.points.reduce((max, point) => {
            if (point.nearestDistance > max &&point.nearestDistance!= Infinity ) return point.nearestDistance;
            else return max
        }, 0)
        console.log(farthestNearest);
        settings.threshold = farthestNearest;
        */
